...
The container story should expand in this order:

1. Dev container for repository development
2. Headless / CI provider for Unity batchmode workflows
3. Optional containerized CI templates

It should **not** expand by forcing the local `tykit` path into Docker.
