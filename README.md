...
> [AI コーディング実践：インディー開発者のドキュメント駆動アプローチ](https://tyksworks.com/posts/ai-coding-workflow-en/) の思想に基づいて開発
...
> [AI 코딩 실전: 인디 개발자의 문서 주도 접근법](https://tyksworks.com/posts/ai-coding-workflow-en/)의 철학을 기반으로 개발
